...
/**
 * Lista resumida de comprovantes de pagamento de débitos veiculares do PR.
 *
 * Origem: POST /v1/debitos-veiculares-pr/lista-comprovantes/listaComprovanteResumidaPr
 */
final class PrComprovanteResumidoResponse implements DTOInterface
{
    use AutoHydrate;
    use CastToArray;

    public function __construct(
        #[ArrayOf(PrComprovanteResumidoItem::class)] public readonly array $lista = [],
        ...
        public readonly ?int $anoPagamento = null,  // ex.: 2023
