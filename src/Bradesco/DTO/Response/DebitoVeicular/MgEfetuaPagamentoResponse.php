...
/**
 * ⚠️ MOVIMENTA DINHEIRO — comprovante do pagamento de débito veicular de MG.
 *
 * `autenticacaoBancaria` é o número do comprovante; guarde-o junto de
 * `identificadorDebito` e `controleSessao` para conciliação e 2ª via.
 *
 * Origem: POST /v1/debitos-veiculares-mg/efetua-pagamento/efetuaPagamentoMG
 */
final class MgEfetuaPagamentoResponse implements DTOInterface
{
    use AutoHydrate;
    use CastToArray;
    ...
    public function __construct(
        ...
        public readonly ?string $autenticacaoBancaria = null,  // ex.: "1164"
        ...
        public readonly ?string $tipoConta = null,  // ex.: "Conta-corrente"
        public readonly ?float $valorPagamento = null,  // ex.: 59.54
    ) {}
}
