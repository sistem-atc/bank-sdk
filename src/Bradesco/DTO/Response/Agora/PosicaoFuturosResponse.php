...
/**
 * Posicao consolidada em contratos futuros.
 *
 * Origem: GET /managers-position-mgmt/v1/consolidatedposition/futures/{cpfCnpj}/{accountCode}
 */
final class PosicaoFuturosResponse implements DTOInterface
{
    use AutoHydrate;
    use CastToArray;
    ...
    public function __construct(
        ...
        /** Contratos futuros em aberto. @var array<int, PosicaoFuturoItem> */
        #[ArrayOf(PosicaoFuturoItem::class)]
