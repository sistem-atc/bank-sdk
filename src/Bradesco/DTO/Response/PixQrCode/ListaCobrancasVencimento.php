...
/**
 * Listagem de cobranças com vencimento — GET `/v2/cobv`.
 *
 * Família PIX (host qrpix) — produto "Pix - geração de QR Code" do Bradesco.
 */
final class ListaCobrancasVencimento implements DTOInterface, UsesCamelCaseKeys
{
    use AutoHydrate;
    use CastToArray;
    ...
    public function __construct(
        ...
        #[ArrayOf(CobrancaVencimento::class)] public readonly array $cobs = [],
    ) {}
}
