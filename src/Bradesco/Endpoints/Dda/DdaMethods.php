...
namespace SistemAtc\Banks\Bradesco\Endpoints\Dda;

use SistemAtc\Banks\Bradesco\Bases\BaseMethods;
use SistemAtc\Banks\Bradesco\DTO\Response\Dda\DdaBoleto;
use SistemAtc\Banks\Common\Enums\HttpMethod;
use SistemAtc\Banks\Contracts\Endpoints\DdaEndpoint;

/**
 * DDA Bradesco — consulta de boletos registrados contra o CNPJ da empresa.
 *
 * ATENÇÃO: o path abaixo é a ESTRUTURA da chamada; o endpoint real e o formato
 * de resposta devem ser confirmados no portal Bradesco (API DDA / Boletos)
