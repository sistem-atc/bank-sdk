...
namespace SistemAtc\Banks\Itau\Bases;
...
/**
 * Base dos grupos de métodos do Itau. Centraliza transporte, retry e
...
abstract class BaseMethods
{
    ...
    {
        $e = new BankRequestException($response, bank: 'itau');

        Log::warning('Itau HTTP Request Error', [
            'status' => $e->status(),
